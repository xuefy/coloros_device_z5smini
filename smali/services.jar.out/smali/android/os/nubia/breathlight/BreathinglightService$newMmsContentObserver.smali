...
.method public onChange(Z)V
    ...
    invoke-static {v3}, Landroid/os/nubia/breathlight/BreathinglightService;->access$000(Landroid/os/nubia/breathlight/BreathinglightService;)I
    ...
    #getter for: Landroid/os/nubia/breathlight/BreathinglightService;->oldMmsSMS:I
    invoke-static {v1}, Landroid/os/nubia/breathlight/BreathinglightService;->access$000(Landroid/os/nubia/breathlight/BreathinglightService;)I
    ...
    invoke-static {v1, v2}, Landroid/os/nubia/breathlight/BreathinglightService;->access$102(Landroid/os/nubia/breathlight/BreathinglightService;Z)Z

    .line 224
    :goto_0
    iget-object v1, p0, Landroid/os/nubia/breathlight/BreathinglightService$newMmsContentObserver;->this$0:Landroid/os/nubia/breathlight/BreathinglightService;

    iget-object v2, p0, Landroid/os/nubia/breathlight/BreathinglightService$newMmsContentObserver;->this$0:Landroid/os/nubia/breathlight/BreathinglightService;

    #getter for: Landroid/os/nubia/breathlight/BreathinglightService;->oldMmsSMS:I
    invoke-static {v2}, Landroid/os/nubia/breathlight/BreathinglightService;->access$000(Landroid/os/nubia/breathlight/BreathinglightService;)I

    move-result v2

    #setter for: Landroid/os/nubia/breathlight/BreathinglightService;->oldMmsSMS:I
    invoke-static {v1, v2}, Landroid/os/nubia/breathlight/BreathinglightService;->access$002(Landroid/os/nubia/breathlight/BreathinglightService;I)I
