...
.method public processMessage(Landroid/os/Message;)Z
    ...
    invoke-static {v5}, Landroid/net/wifi/WifiStateMachine;->access$6400(Landroid/net/wifi/WifiStateMachine;)Landroid/net/NetworkInfo;
    ...
    invoke-static {v5, v6}, Landroid/net/wifi/WifiStateMachine;->access$1902(Landroid/net/wifi/WifiStateMachine;Z)Z
    ...
    #setter for: Landroid/net/wifi/WifiStateMachine;->mTemporarilyDisconnectWifi:Z
    invoke-static {v7, v5}, Landroid/net/wifi/WifiStateMachine;->access$1902(Landroid/net/wifi/WifiStateMachine;Z)Z
    ...
    invoke-virtual {v7, v1}, Landroid/net/wifi/WifiConfigStore;->getConfiguredMatchedNetworks(I)Landroid/net/wifi/WifiConfiguration;

    move-result-object v7

    #setter for: Landroid/net/wifi/WifiStateMachine;->mNextNetwork:Landroid/net/wifi/WifiConfiguration;
    invoke-static {v5, v7}, Landroid/net/wifi/WifiStateMachine;->access$12102(Landroid/net/wifi/WifiStateMachine;Landroid/net/wifi/WifiConfiguration;)Landroid/net/wifi/WifiConfiguration;

    .line 3293
    iget-object v5, p0, Landroid/net/wifi/WifiStateMachine$ConnectModeState;->this$0:Landroid/net/wifi/WifiStateMachine;

    #getter for: Landroid/net/wifi/WifiStateMachine;->mNextNetwork:Landroid/net/wifi/WifiConfiguration;
    invoke-static {v5}, Landroid/net/wifi/WifiStateMachine;->access$12100(Landroid/net/wifi/WifiStateMachine;)Landroid/net/wifi/WifiConfiguration;
    ...
    #calls: Landroid/net/wifi/WifiStateMachine;->sendNextNetworkStateChangeBoradcast()V
    invoke-static {v5}, Landroid/net/wifi/WifiStateMachine;->access$12200(Landroid/net/wifi/WifiStateMachine;)V
    ...
    invoke-static {v5, p1, v7}, Landroid/net/wifi/WifiStateMachine;->access$2000(Landroid/net/wifi/WifiStateMachine;Landroid/os/Message;I)V
    ...
    invoke-static {v7, p1, v8, v5}, Landroid/net/wifi/WifiStateMachine;->access$1100(Landroid/net/wifi/WifiStateMachine;Landroid/os/Message;II)V
    ...
    invoke-static {v5, p1, v7, v2}, Landroid/net/wifi/WifiStateMachine;->access$1200(Landroid/net/wifi/WifiStateMachine;Landroid/os/Message;ILjava/lang/Object;)V
    ...
    invoke-static {v5}, Landroid/net/wifi/WifiStateMachine;->access$5500(Landroid/net/wifi/WifiStateMachine;)Landroid/net/wifi/WifiInfo;
