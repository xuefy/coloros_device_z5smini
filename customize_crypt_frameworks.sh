...
DIR=`pwd`
FILE="app/SystemUI.apk app/SettingsProvider.apk app/Phone.apk framework/android.policy.jar framework/pm.jar framework/services.jar framework/framework.jar"
...
do
	...
	then
		echo copy OppoLauncherSystem.apk as template
		cp -f $DIR/new-update/system/app/OppoLauncherSystem.apk.apk $WKTMP/apk_tmp.apk
